...
#folder creation where the py file exist
 ...
 while True:
    ...
    #New Date folder if 12AM
      ...
      if (keyboard.is_pressed("R") and keyboard.is_pressed("|")):
        while (keyboard.is_pressed("R") and keyboard.is_pressed("|")) == True:
           pass
        ser.write(b'Z')
        for x in Tombs:
             if Tombscall[x-1] == b'A':
     ...
     #To send the LED Configuration Only to Tomb 6
      if (keyboard.is_pressed("F") and keyboard.is_pressed("|")):
        ...
        ser.write(b)
        ser.write(b'X')
        print("LED6config.txt sended")

      #To send the LED Configuration Only to Tomb 7
      if (keyboard.is_pressed("G") and keyboard.is_pressed("|")):
        while (keyboard.is_pressed("G") and keyboard.is_pressed("|")) == True:
           pass
        #send all information inside LEDT7config.txt
        ser.write(b'Z')
        ser.write(b'G')
        ...
        ser.write(b)
        ser.write(b'X')
        print("LED7config.txt sended")

      #To send the LED Configuration Only to Tomb 8
      if (keyboard.is_pressed("H") and keyboard.is_pressed("|")):
        while (keyboard.is_pressed("H") and keyboard.is_pressed("|")) == True:
           pass
        #send all information inside LEDT8config.txt
        ser.write(b'Z')
        ser.write(b'H')
        ...
        ser.write(b)
        ser.write(b'X')
        print("LED8config.txt sended")

      #To send the LED Configuration Only to Tomb 9
      if (keyboard.is_pressed("I") and keyboard.is_pressed("|")):
        while (keyboard.is_pressed("I") and keyboard.is_pressed("|")) == True:
           pass
        #send all information inside LEDT9config.txt
        ser.write(b'Z')
        ser.write(b'I')
      ...
      if (keyboard.is_pressed("J") and keyboard.is_pressed("|")):
        ...
        ser.write(b)
        ser.write(b'X')
        print("LED10config.txt sended")

      #To send the LED Configuration Only to Tomb 11
      if (keyboard.is_pressed("K") and keyboard.is_pressed("|")):
        while (keyboard.is_pressed("K") and keyboard.is_pressed("|")) == True:
           pass
        #send all information inside LEDT11config.txt
        ser.write(b'Z')
        ser.write(b'K')
      ...
      if (keyboard.is_pressed("L") and keyboard.is_pressed("|")):
        ...
        ser.write(b)
        ser.write(b'X')
        print("LED12config.txt sended")

      #To send the LED Configuration Only to Tomb 13
      if (keyboard.is_pressed("M") and keyboard.is_pressed("|")):
        while (keyboard.is_pressed("M") and keyboard.is_pressed("|")) == True:
           pass
        #send all information inside LEDT13config.txt
        ser.write(b'Z')
        ser.write(b'M')
        ...
        ser.write(b)
        ser.write(b'X')
        print("LED13config.txt sended")

      #To send the LED Configuration Only to Tomb 14
      if (keyboard.is_pressed("N") and keyboard.is_pressed("|")):
        while (keyboard.is_pressed("N") and keyboard.is_pressed("|")) == True:
           pass
        #send all information inside LEDT14config.txt
        ser.write(b'Z')
        ser.write(b'N')
        ...
        ser.write(b)
        ser.write(b'X')
        print("LED14config.txt sended")

      #To send the LED Configuration Only to Tomb 15
      if (keyboard.is_pressed("O") and keyboard.is_pressed("|")):
        while (keyboard.is_pressed("O") and keyboard.is_pressed("|")) == True:
           pass
        #send all information inside LEDT15config.txt
        ser.write(b'Z')
        ser.write(b'O')
        ...
        ser.write(b)
        ser.write(b'X')
        print("LED15config.txt sended")

      #To send the LED Configuration Only to Tomb 16
      if (keyboard.is_pressed("P") and keyboard.is_pressed("|")):
        while (keyboard.is_pressed("P") and keyboard.is_pressed("|")) == True:
           pass
        #send all information inside LEDT16config.txt
        ser.write(b'Z')
        ser.write(b'P')
      ...
      if (keyboard.is_pressed("T") and keyboard.is_pressed("|")):
          while (keyboard.is_pressed("T") and keyboard.is_pressed("|")) == True:
           pass
          ser.write(b'T')
          timenow = datetime.datetime.now()
      ...
      #closing and opening the just the files for the tombs that are being use
         ...
         #without this while statement this part of the code will going to repeat too many times,
         #because humans are slower than the computer.
         while (keyboard.is_pressed("Q") and keyboard.is_pressed("|")) == True:
           pass
